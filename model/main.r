...
# clusterApply(cl,test_list,function(el,cont,ksmin,test_list,poids_coef,formula_poids){
#   source("global.r")
#   el[["Protein_val"]]<-na.omit(el[["Protein_val"]])
#   cont<-cont+1
#   print(cont)
...
#   # }
#   # },error=function(e){cat("ERROR :",conditionMessage(e), "\n")})
# },cont,ksmin,test_list,poids_coef,formula_poids)
# for(el in test_list)el[["Protein_val"]]<-na.omit(el[["Protein_val"]])
#     cont<-cont+1
#     print(cont)
#     norm_data<-normaMean(el$Protein_val,el$Transcrit_val,ksmin)
#     fitR<<-"3_deg_log"
